namespace ArquivoCsvBlazorApp.Generator
{
    public class NumberGenerator
    {
        long soma1, soma2, i, erro, cnpj, cpf, parte1, parte2, parte3, dig1, parte5, parte6, parte7, dig2;
        long[] numero = new long[13];
        Random rand = new Random();

        public string CpfComMascara(long quant)
        {
            string result = "";
        ...
        public string CpfSemMascara(long quant)
        {
            string result = "";
            for (cpf = 1; cpf <= quant; cpf++)
            {
        ...
        public string CnpjComMascara(long quant)
        {
            string result = "";
        ...
        public string CnpjSemMascara(long quant)
        {
            string result = "";
            for (cnpj = 1; cnpj <= quant; cnpj++)
            {
